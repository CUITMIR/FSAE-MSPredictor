...
class Wind(Dataset):
    def __init__(self, is_train=True):
        ...
        self.speed_mean = 4.802160
        self.speed_std = 3.196219
        self.direction_mean = 1.240664
        self.direction_std = 33.435359

        this_dir = os.path.dirname(os.path.realpath(__file__))

        self.data_root = os.path.join(this_dir, '../../tools/data/wind_kdd')

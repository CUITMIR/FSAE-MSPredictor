...
def create_parser():
    ...
    parser.add_argument('--res_dir', default='work_dirs', type=str)  # base_dir
    parser.add_argument('--ex_name', '-ex', default='Debug', type=str)  # save_dir = os.path.join(res_dir, ex_name)
    parser.add_argument('--continue_ckpt', default='', type=str)
    ...
    parser.add_argument('--save_every_n_epoch', default=10, type=int)
    parser.add_argument('--set_float32_matmul_precision', action='store_true', default=False)
    parser.add_argument('--disable_find_unused_parameters', action='store_true', default=False)
    ...
    parser.add_argument('--dataname', '-d', default='wind', type=str,
                        choices=['wind', 'wind_kdd'],
                        help='Dataset name (default: "wind")')
    ...
    # method parameters
    parser.add_argument('--method', '-m', default='FSAEMSPredictor', type=str,
                        choices=['FSAE', 'FSAEMSPredictor'],
                        help='Name of video prediction method to train (default: "FSAEMSPredictor")')
    ...
    parser.add_argument('--steps', default=None, type=int, help='end steps (default: -1)')
